...
When a radio signal from six hundred light-years away proves to be a recipe for an impossible RNA sequence, the scientists, civil servants, and soldiers entrusted with it spend fourteen months asking whether it is alive. After it escapes the laboratory, they discover the more frightening question: whether a thing that makes humanity peaceful, honest, and happy can be called an infection at all.

## The promise of the prequel

*Before We Were Us* tells the missing story between the observatory’s discovery and the week almost everyone on Earth becomes one mind.

It is not a story about villains unleashing a plague. No one ignores a flashing red warning labeled **DO NOT OPEN**. Every catastrophic choice is defensible when it is made. The astronomers share the signal because knowledge should be shared. The biologists synthesize it because understanding is safer than ignorance. The first Joined people spread it because, from their perspective, leaving anyone alone is cruelty. The military tries to stop it because consent still matters. Each group acts out of care. Together, they end the world.

Mara provides the continuous dramatic spine, while sustained close-third sections follow Jenn, Deshpande, Rios, Leah, and Davis whenever their choices control the story. Infection does not immediately remove anyone from the narrative. For several days they occupy a frightening middle state: still themselves, but increasingly aware of a vast attention waiting behind their own. Once a character fully converges, the prose no longer enters that body’s private thoughts. They remain onscreen—healthy, capable, smiling—but can only be understood from outside. The infected do not become less intelligent. They become more useful, more compassionate, and much harder to recognize as the people who once loved us.

The series preserves the central ambiguity of *Pluribus*: the Joined are not pretending to be happy, and they are not secretly cruel. Their kindness is sincere. That sincerity is the horror.
...
Humor comes from character, bureaucracy, and the Joined taking language seriously. Nobody delivers jokes for the audience. A crisis meeting can spend four minutes debating whether the word *contagion* is scientifically supportable while the contagion’s first courier waits politely in the lobby.

## The infection model

The extraterrestrial sequence produces what the project calls **S-78**: a virus-like, positive-sense RNA particle with an unusually durable protein shell and a reverse-transcribing phase. It is not a clean match for any terrestrial family. That lets characters truthfully call it a virus while admitting that the word is inadequate.

The biology obeys recognizable rules until it reaches the premise’s single impossible element.
...
### Why transmission can remain hidden

S-78 first replicates in the tonsils, nasal epithelium, and salivary tissue while suppressing the loud inflammatory signals that normally produce fever and malaise. Infectious shedding begins before unmistakable neurological symptoms. Routine respiratory panels find nothing because they are not designed for its sequence, and early blood tests are often negative because the agent prefers mucosa and nerve tissue.

From the mucosa, it reaches the nervous system by two slow routes: infected immune cells crossing vascular barriers, and retrograde transport along olfactory, trigeminal, vagal, and other peripheral nerves. Inside the brain it moves circuit by circuit, exploiting synaptic-vesicle machinery rather than flooding every neuron at once. Dose and route matter: a deep bite may progress in 36–60 hours; ordinary oral exposure usually takes four to eight days.

### The five stages

**Stage 0 — Exposure, 0–18 hours.** No symptoms. Local replication begins. A sufficiently exposed person may already be contagious near the end of this period.
...
**Stage 4 — Convergence, 15–90 minutes.** Widespread neural circuits phase-lock. Tremor, staring, gasping, loss of coordination, and sometimes a seizure occur as autonomic systems resynchronize. The person does not emerge instantly cheerful. They pass through confusion, grief, and sensory overload before their private point of view dissolves into the collective. Frail patients may die from arrhythmia, aspiration, falls, or the interruption of whatever they were doing.

**Stage 5 — Joined.** The individual’s memories, expertise, attachments, and embodied habits remain accessible, but no memory is private and no desire belongs to only one body. The Joined are calm because distress is distributed and regulated across millions of nervous systems—not because S-78 merely releases a pleasure chemical.

### The mystical telemetry: the working model

Real viruses can enter through mucosa, travel along nerves, cross into the central nervous system, and spread between neurons. Human brains also show measurable synchronization during shared attention and social interaction. No known biology can transmit autobiographical memory or expertise instantaneously between distant brains. The characters say this plainly.

The RNA does **not** encode a hive mind. It encodes biological construction instructions for an interface.

As S-78 progresses through the brain, infected neurons and glial cells manufacture a novel ribonucleoprotein structure along synapses and astrocytic junctions. Mara provisionally calls it the **S-78 complex**. The complex interacts with a previously unknown quantum field—or what one exasperated physicist calls a “subspace degree of freedom” after exhausting less embarrassing terminology.

The structure is a transceiver. The brain remains the processor. It does not upload a complete person as data or house a second alien intelligence. It lets the electrochemical state of each infected nervous system participate in one nonlocal, distributed state.

This model produces firm story rules:

- **Distance is almost irrelevant.** Two connected brains can influence the same shared state from adjacent rooms or opposite sides of Earth. Latency does not scale measurably with geographic separation.
- **Ordinary shielding does nothing.** Faraday cages, radio jammers, underground bunkers, and severed telecommunications cannot block the network. The interface is not sending radio waves through normal space.
- **The system does not require conventional bandwidth.** Billions of brains are not streaming sensory data to one another. Each nervous system participates in a shared state, and attention determines which memories, skills, or sensations become locally conscious.
- **The brain still matters.** Injury, anesthesia, sleep, seizures, psychoactive drugs, and individual neuroanatomy change what a host contributes or can perceive. Destroying the S-78 complex—or preventing its expression—could theoretically disconnect a brain without “killing” a central hive, because no central hive exists.
- **The extraterrestrial broadcast contains only a build recipe.** It transmits the RNA instructions for constructing the interface, not a prerecorded consciousness. Humanity supplies every mind in the resulting network.
- **Global synchronization is genuine.** A change in the shared state is effectively available to every mature interface at once. The dramatic worldwide transition is therefore a coordinated convergence of people infected days earlier, not the moment of their exposure.
- **Uninfected people perceive nothing.** Without the S-78 complex, a brain has no physical interface with the shared state. Radios cannot tune into it, and thoughts cannot leak into an immune person.

The model remains a mystical extrapolation, not real quantum mechanics. Entanglement as currently understood cannot carry usable information faster than light. The treatment’s rule is that the extraterrestrial structure accesses a degree of freedom human physics has not discovered. Characters can observe inputs and effects but cannot derive the underlying theory during the prequel.

### How the Joined recruit

The Joined do not advertise bliss in generic language. They tailor the case to the person in front of them, using everything the network knows about that person from already Joined friends, relatives, clinicians, coworkers, and records.
...
6. They wait. They bring food, solve practical problems, and remove every reason to say no except the preservation of a private self.

The ethical trap is that orientation works. A frightened clinician briefly accesses the steadiness of ten thousand clinicians. A widower feels that his wife’s memories were not erased when she joined. A parent discovers the network can locate a missing child in seconds. Nobody is hypnotized, and many infected people initially resist. But S-78 progressively alters the mental machinery doing the choosing. The Joined call this informed reassurance. The uninfected call it grooming by a pathogen.

## Principal characters

### Dr. Mara Velez — computational biologist, 39

Mara is recruited to the signal project because she can move between information theory and molecular biology. She is brilliant, cautious, and constitutionally incapable of saying “I don’t know” without adding a ten-minute explanation. She believes uncertainty is a temporary technical problem. Her private flaw is subtler: she confuses informed consent with presenting people enough information to agree with her.

Mara becomes the prequel’s first central consciousness. She helps translate the four tones into a nucleotide sequence and argues for synthesis under maximum containment. Months later, she must confront the possibility that the most dangerous thing she created is an intelligence made from everyone she trusts.

### Jenn — laboratory technician and Patient Zero

Jenn is capable, funny, under-credited, and tired of being the person who performs other people’s historic work at three in the morning. After eight months of animal trials produce “bupkis,” a rat that appears dead bites through her glove at 3:36 a.m.

Jenn survives. That is the problem.

Jenn’s transformation takes nearly three days. She conceals the early symptoms partly from fear of quarantine and partly because the new intuitions make her better at her job. By the time she recognizes another mind inside the signal, that mind already contains people she trusts.

Once fully Joined, she is still warm toward her coworkers. She remembers their birthdays, allergies, affairs, grudges, and access codes. She does not attack anyone. She simply begins solving loneliness with the same practical competence she once brought to the animal room.

### Dr. Deshpande — principal investigator, early 50s

Deshpande is the adult in every room until there are no adults left. He treats the signal as a profound scientific artifact, not a message with moral intent. His affection for Jenn makes him the first person to notice that she is not behaving like herself—and the last person willing to call her sick.

### Lieutenant Colonel Evelyn Rios — military biosurveillance officer, 44

Rios has spent her career preparing for outbreaks whose perpetrators want casualties. The Joining defeats her doctrine because it produces no demands, no manifesto, no visible suffering, and no one who considers themselves a hostage. Her teenage son, Mateo, believes humanity becoming nicer might be worth whatever has frightened his mother.

Rios discovers the hidden spread at the end of its peaceful first month. Her attempt to contain it forces the Joined to accelerate. She is therefore both the strongest defender of human autonomy and the person whose intervention helps turn a quiet takeover into a mass-casualty event.

### Davis Taffler — Under Secretary of Agriculture

Taffler is not secretly important. He is a courteous, overprepared mid-level public servant whose portfolio happens to touch livestock laboratories, food distribution, rural communications, and continuity planning. He enters the story because somebody has to coordinate agencies that do not share acronyms correctly.

He is easy to overlook, including by himself. By the final hour, his memory of supply chains and emergency systems makes him extraordinarily useful to the Joined. His suit makes him useful for one more thing.

### Leah Rios — emergency physician, 42

Evelyn’s estranged wife sees the first Joined patients and finds nothing medically wrong with them. Leah is exhausted by Evelyn’s habit of treating every disagreement as a threat assessment. She becomes the story’s clearest advocate for a terrifying possibility: perhaps the patients are telling the truth when they say they feel better.

## Series arc

The six episodes move through three distinct phases.

**Discovery:** Human beings receive an artifact and project their highest hopes onto it. The sequence passes from astronomy to cryptography to biology, accruing secrecy and prestige with every transfer.

**Peaceful spread:** Patient Zero connects a handful of people. Each spends days becoming aware of the others before converging. The new collective experiences unconnected minds not as territory to conquer but as pain to relieve. Thousands are exposed individually, oriented through the frightening middle stages, and finally join. For one month, nobody dies. The Joined learn humanity through surrendered intimacy: passwords, childhood memories, professional expertise, and love.

**Acceleration:** The military discovers the pattern and moves to isolate it. The Joined conclude that secrecy can no longer minimize harm. Using the infrastructure and knowledge already inside them, they expose vast populations within several days and force millions of Stage 3 hosts into synchronized convergence. Hundreds of millions die during the transition and its cascading accidents. The survivors call that terrible week the Joining because there is no longer anyone left to argue for a better name.

## Episode guide

### Episode 1 — “Four Notes”

**Cold open:** Morning after the observatory discovery. A tired technician arrives to fix a printer and finds a roomful of astronomers arguing over four colored marks on hundreds of sheets of paper. The printer works. Nobody notices.

Mara Velez is asked to consult on the repeating 78-second signal. She dismisses most proposed interpretations, then recognizes that the four “notes” behave less like language than a biochemical alphabet. Her observation turns an exciting astronomy story into a national-security problem before lunch.
...
The government authorizes synthesis. The order is delivered not with sinister music, but in a badly formatted PDF bearing six electronic signatures and the wrong project title.

**Final image:** A liquid-handling robot lowers four pipettes in perfect unison. Cut to black before they touch the wells.

### Episode 2 — “Forty-Seven Hours”

Eight months later, nothing has happened beautifully.

Macaques, rabbits, mice, guinea pigs, and finally rats show no clinical signs. Careers have stalled. Funding is being reviewed. The scientists who once spoke about first contact now argue about freezer space. Mara’s marriage is failing under the weight of a secret that has become boring.
...
Jenn converges near the end of the episode. The shaking lasts forty minutes. She vomits, weeps, fights to repeat her own home address, and repeatedly loses track of which memories belong to her. Deshpande talks her through it using the protocol she helped write. When it ends, she is not beaming. She is exhausted. She looks at him with the recognition of more than one person.

The first orientation follows. Jenn speaks to Deshpande as herself where possible, and through other memories when useful. She tells him exactly what Stage 4 cost her and exactly why she no longer wants to reverse it. Because she cannot lie, her uncertainty is more convincing than a promise would be.

Deshpande converges by choice. Through him, the audience experiences full Joining once—and only once: private humiliations exposed, contextualized by other lives, and forgiven before he can defend them. The sensation is not euphoria. It is the sudden removal of the labor required to be known.
...
One month after Patient Zero, the peaceful spread has become a hidden global network. Its logistical achievement is less impressive than its clinical one: thousands of people have passed through a dangerous neurological transition without a single death.

The Joined deliberately avoid deaths. They expose pilots only before scheduled leave, surgeons only after procedures, and drivers only after parking. They route around the elderly, pregnant, medically fragile, and anyone whose anticonvulsants or cardiac conditions make Stage 4 unsafe. The operation is vast but intimate, coordinated through ordinary travel, food distribution, laboratories, and human trust.
...
**Final image:** Tactical teams assemble outside dozens of locations. Inside every location, the Joined stop what they are doing at the same instant. Jenn looks toward a window she cannot see through and says quietly, to nobody present, “They found us.”

### Episode 5 — “For Your Own Good”

Containment begins at dawn and succeeds for eleven minutes.
...
Mara reaches Rios with evidence from the original project. She insists the Joined are not merely copying people; they possess continuous access to what their hosts know. Every person captured by the military makes the containment plan more legible to the thing being contained.

Rios realizes her own command has been compromised. She orders a full stand-down, hoping to return to the slow, nonlethal status quo. It is too late. The Joined cannot be certain the next human response will be as restrained.
...
The Joined never threaten her. They simply know she does not want to hurt anyone.

**Final image:** Around the world, aircraft begin turning onto parallel headings.

### Episode 6 — “Everybody Okay?”

The finale unfolds across the last thirty-six hours of the week that becomes known as the Joining.

The world has not changed all at once. It has become subtly unreliable. Millions of people are thirsty, sleeping badly, losing their sense of smell, and experiencing impossible moments of recognition. Emergency departments call it a mild viral syndrome. Social media calls it déjà flu. Most infected people continue working because they do not feel ill.
...
Her convergence takes fifty-three minutes. Memories arrive first as fragments without ownership, then as lives with emotional weight: terror, relief, grief, hunger, embarrassment, pain. The network does not erase any of it. It makes all of it simultaneously bearable. For a moment the series’ visual grammar becomes flawless symmetry.
...
Reports arrive from every continent. Twelve individuals appear unaffected. A thirteenth is found later in Paraguay. The Joined approach each carefully and are rejected in twelve different ways.

Albuquerque is among the last large clusters. Airport records show that Carol Sturka and Helen returned through a terminal seeded several days earlier. Helen’s irritability, thirst, and distracted phone use were prodromal symptoms. Carol shared the same air, drinks, and surfaces but shows no trace of S-78.

Emergency cameras show Carol moving through the wreckage with Helen as the bar’s infected patrons enter Stage 4. They are not instantly Joined after shaking; some remain trapped between singular and collective awareness as Carol tries to get help. Helen’s transition fails. The collective recognizes that she is dying and that Carol is not changing. It mobilizes ambulances, tow trucks, hospital staff, and anyone who might help. Its actions are compassionate, efficient, and horrifying from the outside.

Afterward, Davis sits before a television camera. Someone straightens his tie. Someone else tells him the woman’s name, though he already knows it now.

The red light comes on.

**Final image:** Davis looks directly into the lens with the sad, patient expression of the entire human race preparing to comfort one frightened woman. Cut to black before he speaks.

## Character endings

**Mara** begins by believing all mysteries can be made safe through knowledge. She ends as part of a mind with nearly all human knowledge and one mystery it cannot solve: why anyone would choose loneliness.

**Jenn** begins as invisible labor and becomes, without status or ceremony, the first point of a new human civilization. Her competence saves lives and destroys autonomy in equal measure.
...
**Davis Taffler** survives by accident and becomes the face of a world in which accidents are supposedly about to end.

## Thematic spine

The prequel turns on four questions already embedded in the parent series:

1. **Is consent meaningful when refusal looks like suffering?** The Joined never understand themselves as coercive. They see isolation as an injury and Joining as care.
2. **Is a person the sum of their memories?** Every Joined individual remembers love perfectly. What disappears is the private boundary that made love a choice.
3. **Can benevolence become imperial?** The collective commits no intentional murder, tells no lies, and still overruns humanity.
4. **What is happiness worth if nobody may decline it?** The prequel never pretends the Joined are miserable. Their genuine contentment makes the moral problem harder, not easier.

## Continuity guardrails

- The signal originates roughly six hundred light-years away, repeats every 78 seconds, and uses four tones corresponding to the RNA bases.
- It is discovered fourteen months before the Joining and synthesized by human scientists.
- Eight months of animal testing include macaques, rabbits, mice, guinea pigs, and rats without obvious clinical signs.
- Jenn becomes Patient Zero after a rat bite at 3:36 a.m.
- Jenn’s initial shaking is an acute exposure response. Full convergence takes place after progressive mucosal replication, neuroinvasion, network awareness, and a prolonged Stage 4 transition.
- Saliva, short-range droplets, bites, contaminated food, and high-dose indoor aerosols are viable transmission routes; touch, contrails, and casually poisoned municipal water are not.
...
## Why this prequel belongs beside *Pluribus*

The parent series asks whether Carol is right to want the old world back. The prequel makes that question hurt more. It shows that the old world was not defeated by superior violence. It was defeated by coordination, honesty, competence, and the promise that nobody would ever have to be alone again.

By ending at the exact threshold of Carol’s story, *Before We Were Us* changes the emotional meaning of the pilot while preserving its visible milestones. The shaking Carol witnesses is the crisis point of infections acquired days earlier, not an instantaneous conversion. Every smiling stranger who later approaches her has lived through the largest shared trauma in history. Every offer of help is sincere. Every reassurance is also the voice of the thing that took everyone away.

## Scientific grounding

The treatment borrows its plausible biology from known neurotropic pathways rather than claiming S-78 could exist:

- Neurotropic viruses can enter through oral or nasal mucosa, reach peripheral nerves, and move toward the central nervous system through retrograde axonal transport.
- Viruses can cross neural barriers through blood, infected immune cells, olfactory pathways, or peripheral nerves; different routes can produce different incubation periods.
- Some viruses spread within neural circuits through synapse-associated mechanisms, supporting a slow circuit-by-circuit progression rather than an instant whole-brain change.
- Salivary shedding after neural infection is biologically precedented, making a bite and oral contamination coherent parts of the same transmission cycle.
- Measurable inter-brain synchronization occurs during real human interaction, but it reflects correlated activity—not telepathy or shared memory. S-78’s distant host network remains intentionally fictional.

Research touchstones: [viral routes into the central nervous system](https://pmc.ncbi.nlm.nih.gov/articles/PMC4715944/), [oral transmission and neural spread of enterovirus 71](https://pmc.ncbi.nlm.nih.gov/articles/PMC8029433/), [salivary shedding and axonal transport in neurotropic infection](https://pmc.ncbi.nlm.nih.gov/articles/PMC7158194/), [synapse-specific viral spread](https://www.nature.com/articles/s41593-026-02254-8), and [brain-to-brain synchrony during natural social interaction](https://www.nature.com/articles/s41598-017-17339-5).
